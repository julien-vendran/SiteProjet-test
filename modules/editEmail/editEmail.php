...
<body>
    ...
    <?php
        ...
        echo '
            <form method="get" action="updated.php">
            <div class="form-group row">
                <div class="form-group col s12">
                    <div class="input-group-addon"><i class="material-icons">edit</i></div>
                    <input type="text" class="form-control" name="obj" value="'.htmlspecialchars($_GET['obj']).'">
                </div>
                <div class="form-group col s12">
                    <div class="input-group-addon"><i class="material-icons">edit</i></div>
                    <textarea class="form-control" id="mail_content" name="email" required/>'.htmlspecialchars($_GET['email']).'</textarea> 
                </div>
                <div class="input-group col s6">
                    <div class="input-group-addon"><i class="fa fa-sort"></i></div>
                    <select class="form-control" id="mailto_list" name="promo" value="'.htmlspecialchars($_GET['promo']).'">
                ...
                <input type="hidden" class="form-control" name="id" value="'.htmlspecialchars($_GET['id']).'">
