$(window).load(function() {
  ...
  $("#_infos-modal .modal-content .modal-body span.delete").click(function() {
    if (confirm("Êtes-vous sur de vouloir supprimer ce projet ?")) {
      var id = $("#_infos-modal").find(".modal-title h2").attr("id");
      deleteProject(id);
    }
  });

  // Fonction de modification
  $("#_infos-modal .modal-content .modal-body span.modify").click(function() {
    var id = $("#_infos-modal").find(".modal-title h2").attr("id");
    window.location.href = 'edition/index.php?id='+id;
  });
...
(function($) {
    ...
    $(".projectlist li").on('click', function () {
      ...
      $("#_infos-modal").find(".modal-title h2").attr("id", projectList[project].idProjet);
...
// Fonction qui permet la suppression du projet demandé
